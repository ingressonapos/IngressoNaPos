...
<title>Home</title>
<link href="<c:url value='/'/>/css/GDL.css" rel="stylesheet"
	type="text/css" />
...
function exibeTarefas(data) {
	$("#visitasPendentes").html("<img src='<c:url value='/'/>/images/load2.gif'>");
	$("#visitasPendentes").load("visitas/listaPendentes/"+data);
}
...
<div id="menu"><%@ include file="../cabecalho.jsp"%></div>
...
<div style="height: 768px; width: 100%">
	<div class="column" style="width: 650px">
		...
		<div class="portlet">
			<div class="portlet-header">Visitas pendentes
			</div>
			<div class="portlet-content">
				<div id="visitasPendentes" style="overflow:auto; height: 150px">
				</div>
			</div>
		</div>
	</div>
