        ...
        AbstractDaoImpl<Integer,DadosPessoais>
{
    ...
    public void deletarDadosPessoais(
        DadosPessoais dadosPessoais )
    {
    ...
    public DadosPessoais procurarDadosPessoaisPorEmail(
        String email )
    {
    ...
    public DadosPessoais procurarDadosPessoaisPorCedulaDeIdentidade(
        CedulaDeIdentidade cedulaDeIdentidade )
    {

        final List<DadosPessoais> dadosPessoais = findByCriteria( Restrictions.eq(
            "cedulaDeIdentidade", cedulaDeIdentidade ) );
